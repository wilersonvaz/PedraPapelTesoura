...
public class JogarContraDois extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogar_contra_dois);
        ...
        Toast.makeText(this, "Rodada: "+String.valueOf(nRodadas), Toast.LENGTH_SHORT).show();
